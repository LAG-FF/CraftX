// If u don't understand anything don't
// ask me i am just a craftland creator
// not a fulltime coder

// all comments are generated by ai (Deepseek)
// some bugs are also fixed by ai (Deepseek)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    brand.addEventListener('click', () => {
        window.open('https://linktree.craftx.site/craftx', '_self');
    });
    ...
    fetchData('team').then(data => {
        ...
        contentEl.innerHTML = `<div class="error">Failed to load data. Refresh the page to try again.</div>`;
    });
